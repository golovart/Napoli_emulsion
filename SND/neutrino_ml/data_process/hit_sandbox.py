...
# parser.add_argument("-f", "--inputFile", dest="inputFile", help="input file data",default="",required=False)
...
#    out_path += options.etype+'_'+MCDir.split('/')[-2]+'.h5'
#elif len(out_path.split('/'))<3:
#    out_path = '/afs/cern.ch/user/g/golovati/work/neutrino_ml/MC_explore/data/' + out_path
